...
const ADDRESS_OBJ = {
  "mainnet": {
    ...
    USDC: "0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48" //TODO: Add COMPOUNDVIEW to mainnet
  },
  "ropsten": {
    CDAI: "0xf0d0eb522cfa50b716b3b1604c4f0fa6f04376ad",
    CUSDC: "0x8af93cae804cc220d1a608d4fa54d1b6ca5eb361",
    DAI: "0x31f42841c2db5173425b5223809cf3a38fede360",
    USDC: "0x0D9C8723B343A8368BebE0B5E89273fF8D712e3C" //TODO: Add COMPOUNDVIEW to ropsten
  },
  "goerli": {
    ...
    COMPOUNDVIEW: "0xb86Be1533A36873fA502b4028fC52FC2ceE7D3C3"
  }
};

const ACHIEVEMENT_CONTRACT_ADDRESS = process.env.GATSBY_ACHIEVEMENT_CONTRACT_ADDRESS;
const ETHEREUM101_CONTRACT_ADDRESS = process.env.GATSBY_ETHEREUM101_CONTRACT_ADDRESS;

const ADDRESS = ADDRESS_OBJ[TESTNET_NAME];

const GAS_PRICE = 25e9; //25 gwei
