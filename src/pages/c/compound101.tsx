...
const Compound101 = () => {
  ...
  return (
    <Layout>
      ...
      <div style={{textAlign: "center", marginBottom: 20}}><EthEducationButton onClick={()=>{if (currentWalletETHBalance < GAS_PRICE * 1e6) {setIsAccountModalOpen(true)} else {approveButtonHandler(account, web3, txPending)}}} disabled={isTransactionPending || isApproveComplete}>{isApproveComplete ? "Approved" : "Approve"}</EthEducationButton></div>
